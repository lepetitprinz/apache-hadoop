...
/*
 * Application to find the maximum temperature by station, showing station names
 * from a lookup table passed as a distributed cache file
 */
public class MaxTemperatureByStationNameUsingDistributedCacheFile
    ...
    static class MaxTemperatureReducerWithStationLookup
        ...
        /*
         * Retrieve the cache file using its original name
         */
        @Override
    ...
    public int run(String[] args) throws Exception {
        ...
        // use the cache file to look up the station name
