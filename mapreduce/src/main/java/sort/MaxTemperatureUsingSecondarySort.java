...
public class MaxTemperatureUsingSecondarySort extends Configured implements Tool {
    ...
    static class MaxTemperatureMapper extends Mapper<LongWritable, Text, IntPair, NullWritable> {
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            if (parser.isValidTemperature()) {
                context.write(new IntPair(
                    parser.getYearInt(), parser.getAirTemperature()), NullWritable.get());
            }
        }
    }
    ...
    public static class KeyComparator extends WritableComparator {
        protected KeyComparator() { super(IntPair.class, true); }
        ...
        public int compare(WritableComparable w1, WritableComparable w2) {
            ...
            if (cmp != 0) { return cmp; }
            return -IntPair.compare(ip1.getSecond(), ip2.getSecond()); // reverse sort
        }
    }

    public static class GroupComparator extends WritableComparator {
        protected GroupComparator() { super(IntPair.class, true); }
